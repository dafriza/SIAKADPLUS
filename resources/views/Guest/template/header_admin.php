...
<head>
    ...
    <link rel="stylesheet" href="/assets/table_admin1.css">
                            ...
                            <li class="nav-item active">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="https://siakadplus.com/view/admin/landing_page.php">Home</a>
                                        <a class="dropdown-item" href="https://siakadplus.com/view/admin/add.php">Add Data</a>
