        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="">
                    ...
                    <a href="index.php" aria-expanded="false" class="">Home</a>
                </li>
                <li>
                    <a href="#">About</a>
                </li>
        ...
        <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="table-list.php">Table List</a>
                            </li>
                            <li class="nav-item">
            ...
            <section>
                ...
                <div class="section-img" id="home">
                    ...
                    <div class="headline">
                        <h2>SIAKAD+</h2>
                        <p>Platform Digital yang dikembangkan untuk Mahasiswa dan Dosen bertemu. Dimana bisa membuat kelas dan bergabung bersama. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga eaque similique error quia aliquid cumque saepe beatae deserunt, </p>
                    </div>
                </div>
                <!-- End Of Bg Section -->
