...
// include "../config/get_form.php";
$open = fopen($_SERVER['DOCUMENT_ROOT']."/assets/JSON/data.json", "r");
$file = fread($open, 1024);
$data_form = json_decode($file, true);
?>
<?php
...
<body>
    ...
    <section>
        ...
        <div class="section-img" id="home">
            ...
            <div class="headline">
                <h2><?= $data[0]['title'] ?></h2>
                <p style="font-size:20px">Nama : <?= strtoupper($data_form['nama']);?></p>
                <p style="font-size:20px">Tingkat Skill : <?= strtoupper($data_form['tingkat_skill']);?></p>
                <p style="font-size:20px">Tingkat Project : <?php foreach ($data_form['tingkat_project'] as $key => $value) {
