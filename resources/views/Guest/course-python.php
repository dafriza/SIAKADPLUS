...
<body>
    ...
    <section>
        ...
        <div class="section-img" id="home">
            ...
            <img src="/assets/landscape-python.png" alt="">
            <!-- <img src="/siakad/assets/landscape-python.png" alt=""> -->
            <div class="headline">
                <h2>Python Course</h2>
                <p>Mempelajari dari tingkat beginner sampai mahir.</p>
                <br>
                <a href="">
                    <button>
                        Enroll Now
        ...
        <div class="section-content" id="kategori">
            ...
            <div class="news">
                <div class="detail-news">
                    <!-- <img src="https://venngage-wordpress-gallery.s3.amazonaws.com/uploads/2018/10/Infographic-Examples-3.png" alt=""> -->
                    <img src="/assets/python-logo.png" alt="">
                    <!-- <img src="/siakad/assets/python-logo.png" alt=""> -->
                    <br>
                    <span>Beginner</span>
                    <br>
                    <button>
        ...
        <div class="section-category">
            ...
            <img src="https://www.mindmeister.com/export/image/752422209?height=600&t=EfjNp00HBU&variable_size=1&width=1200" width="55%" height="auto" alt="">
        </div>
